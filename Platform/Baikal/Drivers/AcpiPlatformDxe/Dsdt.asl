...
#if defined (BAIKAL_MBM10) || defined (BAIKAL_MBM20) || defined (BAIKAL_MITX)
...
#elif defined (BAIKAL_MBM10) || defined (BAIKAL_MBM20) || defined (BAIKAL_MITX)
...
#if defined(BAIKAL_DBM) || defined(BAIKAL_MBM20) || (defined (BAIKAL_MITX) && BOARD_VER == 2) // remove MBM20 before release
    // VDU_LVDS
    Device(VDU0) {
      Name(_HID, "PRP0001")
...
#if defined(BAIKAL_MBM10) || (defined (BAIKAL_MITX) && BOARD_VER==0)
          Package() { "snps,reset-gp-out", One },
          Package() { "snps,reset-active-low", One },
#elif defined (BAIKAL_MBM20) || (defined (BAIKAL_MITX) && BOARD_VER==2)
...
#ifdef BAIKAL_MBM10
            ^GPIO.GPIP, 27, Zero
#elif defined (BAIKAL_MBM20) || define(BAIKAL_MITX)
            ^GPIO.GPIP, 29, Zero
#endif
          }},
