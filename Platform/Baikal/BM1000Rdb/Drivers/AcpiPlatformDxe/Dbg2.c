...
#define BAIKAL_DBG2_UART_ADDRESS_LENGTH                  0x10000
...
#define BAIKAL_DBG2_PORT(UartBase, UartName)  {                                                    \
  {                                                                                                \
    ...
    /* UINT16  PortSubtype                     */                                                  \
    BAIKAL_ACPI_PORT_SUBTYPE_SERIAL_16550_GAS,                                                     \
    /* UINT8   Reserved[2]                     */                                                  \
...
STATIC BAIKAL_ACPI_DBG2  Dbg2 = {
  ...
  {
    BAIKAL_DBG2_PORT (0x20230000, BAIKAL_DBG2_NAME_PORT0),
    BAIKAL_DBG2_PORT (0x20240000, BAIKAL_DBG2_NAME_PORT1)
  }
};
#pragma pack()
